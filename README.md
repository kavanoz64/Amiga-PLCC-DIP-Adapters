...
When building:
1. Optional but recommended: Place the PLCC socket onto the PCB (do not solder) and trim the pins flush to the PCB.
...
![CIA-Iso](Images/CIA-Iso.png)

![CIA-Top](Images/CIA-Top.png)

![Denise-Iso](Images/Denise-Iso.png)

![Denise-Top](Images/Denise-Top.png)

![Paula-Iso](Images/Paula-Iso.png)

![Paula-Top](Images/Paula-Top.png)
